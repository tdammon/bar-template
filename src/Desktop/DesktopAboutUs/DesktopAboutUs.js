        ...
        <div className="deaktopMainContent">
          <div>
            ...
            <p>
              ...
              BBQ and cooking in general from my family, friends and through
              vast research on different BBQ styles and recipes. I have cooked
              for gatherings with family and friends for many years, and over
              time, was able to create a number of recipes that became friend
              and family approved. During the pandemic of 2020, I did some soul
              searching and realized that I needed to change jobs and start
              doing something I truly loved - and that’s how we came to be.
              <br></br>
              ...
              run out of menu items before normal closing hours. We’re sorry,
              but when it’s gone - it’s gone. We’ll have more freshly made for
              you the next day.
            </p>
          </div>
          <div>
            ...
            <p>
              <ul>
                ...
                <li>
                  ...
                  utilize eco-friendly packaging and utensils whenever
                  available.
                </li>
                <li>
                  We will be known as a local business that cares about Winona
                  and it’s citizens and continuously prove this through our
                  actions.
                </li>
              </ul>
            </p>
